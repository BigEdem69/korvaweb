      ...
      <section className="section">
        <div className="wrap">
          <SectionHead
            ...
            title="Built for the People Who Use It Every Day"
            center
          />
          <div className="mt-12 grid items-center gap-8 sm:grid-cols-3">
            <figure className="text-center">
              <img
                src={shotResidentHome}
                alt="Resident home screen"
                loading="lazy"
                className="mx-auto w-full max-w-[220px] rounded-2xl border border-border shadow-[0_20px_44px_-22px_rgba(11,94,74,0.25)]"
              />
              <figcaption className="mt-3 text-xs text-muted-foreground">Resident: report &amp; track</figcaption>
            </figure>
            <figure className="text-center">
              <img
                src={shotOpsDashboard}
                alt="Operations dashboard"
                loading="lazy"
                className="mx-auto w-full rounded-2xl border border-border shadow-[0_20px_44px_-22px_rgba(11,94,74,0.25)]"
              />
              <figcaption className="mt-3 text-xs text-muted-foreground">Operations: review &amp; assign</figcaption>
            </figure>
            <figure className="text-center">
              <img
                src={shotSupervisorVerify}
                alt="Supervisor verify screen"
                loading="lazy"
                className="mx-auto w-full max-w-[220px] rounded-2xl border border-border shadow-[0_20px_44px_-22px_rgba(11,94,74,0.25)]"
              />
              <figcaption className="mt-3 text-xs text-muted-foreground">Supervisor: verify &amp; close</figcaption>
            </figure>
          </div>
          <div className="mt-10 text-center">
            <Link to="/korva-waste" className="rule-link mx-auto w-fit">
